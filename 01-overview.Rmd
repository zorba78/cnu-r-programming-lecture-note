...
```{r rstudio-comp, fig.align='center', echo=FALSE, fig.show='hold', out.width='90%', fig.cap="RStudio 화면구성: 우하단 그림은 http://r-statistics.co/Top50-Ggplot2-Visualizations-MasterList-R-Code.html 에서 발췌", ref.label='rstudio-windows'}
