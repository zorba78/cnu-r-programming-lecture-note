...
`설명` <- c("그래픽 장치(device), figure, plot 영역 크기(너비: width, 높이: height) 조정(인치 단위)", 
            ...
            "장치영역 일부로 표현된 plot 영역 좌표", 
            "Figure 영역의 plot 스타일 지정. s = 정방형, m = 최대")
tab05_01 <- data.frame(
  Parameter, 
  `값`, 
  `설명`, 
...
```{r layout-par, fig.show="hold", out.width="50%", fig.cap="레이아웃 파라미터. [AIMS-R-Users](http://users.monash.edu.au/~murray/AIMS-R-users/ws/ws11.html)에서 발췌"}
