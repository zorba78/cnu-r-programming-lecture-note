...
```{block2, type="rmdnote"}
본 절에서 사용한 동영상 및 모의실험 코드는 Yihui Xie와 Lijia Yu가 배포한 animation 패키지의 내용을 
기반으로 재구성함. 
```
...
```{r, echo=FALSE, message=FALSE}
library(icons)
fontawesome("dice-one", style = "solid") |> icon_style(scale = 5) 
fontawesome("dice-two", style = "solid") |> icon_style(scale = 5) 
fontawesome("dice-three", style = "solid") |> icon_style(scale = 5) 
fontawesome("dice-four", style = "solid") |> icon_style(scale = 5) 
fontawesome("dice-five", style = "solid") |> icon_style(scale = 5) 
fontawesome("dice-six", style = "solid") |> icon_style(scale = 5) 
...
```{r fig.align='center', echo=FALSE, fig.show='hold', out.width='90%', fig.cap="트럼프 구성(https://statkclee.github.io/r-algorithm/ 에서 발췌"}
options(knitr.graphics.auto_pdf = TRUE)
knitr::include_graphics('figures/trump-cards.png', dpi = NA)
