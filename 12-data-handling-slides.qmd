...
그림이 키라고 그려 뒀어도 틀릴 수 있습니다. 1년에 한 번 있는 일은 앞 몇 행을 봐서는 절대 드러나지 않습니다. 키는 반드시 세어서 확인하세요.
:::
...
왼쪽 표를 보세요. (a) 는 나라마다 한 표씩 셉니다. 인구 750만인 홍콩의 57,000 달러와 14억인 중국의 18,000 달러가 같은 무게로 평균됩니다. (b) 는 동아시아 사람 한 명당 GDP 라서, 인구가 압도적으로 많은 중국의 값에 가까워집니다.
...
어느 평균이 맞는지는 계산이 아니라 질문이 정합니다. 통계학과에서 꼭 가져가야 할 감각입니다.
:::
