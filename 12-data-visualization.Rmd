...
```{r bar-plots-ex, fig.width=10, fig.heigh=7, echo=FALSE, fig.show="hold", message=FALSE}
require(ggpubr)
require(gridExtra)
...
```{r bar-plots-ex2, fig.width=10, fig.heigh=7, echo=FALSE, fig.show="hold"}
ggarrange(p1, p2, ncol = 2)
...
```{r bar-plots-ex3, fig.width=11, fig.heigh=7, echo=FALSE, fig.show="hold"}
ggarrange(p1, p2, ncol = 2)
...
```{r, echo=FALSE, fig.width=12, fig.height=7, fig.show="hold"}
ggarrange(p1, p2, ncol = 2)
```
...
```{r, errorbar-ex1, fig.width=10, fig.heigh=6, fig.show="hold"}
# geom_errorbar() 예시
...
```{r, errobar-ex2, fig.width=10, fig.heigh=6}
# 오차 막대 도표2
# 선과 점 추가
# 집단 별 위치 및 막대 조정
gerror_init + 
...
```{r, errobar-ex3, fig.width=10, fig.heigh=6, fig.show="hold"}
...
```{r, errobar-ex4, fig.width=10, fig.heigh=7, fig.show="hold"}
# warpbreaks 데이터
...
```{r, fig.width = 11, fig.height=7, fig.show="hold"}
# geom_linerange 예시
# 정규 난수 생성
# 표본 크기 n = 30, 반복 N = 200
# 평균 mu = 20, 표준편차 sx = 10
...
```{r, fig.width = 11, fig.height=9, fig.show="hold", echo=FALSE}
...
```{r, fig.width=8, fig.height=8, fig.show="hold", fig.cap="hjust와 vjust 값에 따른 텍스트 위치. https://ggplot2.tidyverse.org/articles/ggplot2-specs.html 인용"}
...
```{r, echo=FALSE, message=FALSE, fig.align='center', echo=FALSE, fig.show='hold', out.width='100%', warnings=FALSE}
...
```{r, fig.width=8, fig.height=5, fig.show="hold"}
x <- seq(-3, 3, by = 0.01)
z <- dnorm(x)
...
```{r, echo=FALSE, fig.width=9, fig.height=9, fig.show="hold"}
...
```{r, echo=FALSE, fig.width=10, fig.height=4, fig.show="hold"}
...
```{r, echo=FALSE, fig.width=12, fig.height=8, fig.show="hold"}
...
```{r, echo=FALSE, fig.width=14, fig.height=8, fig.show="hold"}
ggarrange(p1, p2, p3, p4, ncol = 2, nrow = 2)
...
```{r, echo=FALSE, fig.width=12, fig.height=5, fig.show="hold"}
ggarrange(p1, p2, ncol = 2)
...
```{r, echo=FALSE, fig.width=12, fig.height=8, fig.show="hold", cache=TRUE}
ggarrange(p1, p2, p3, p4, ncol = 2, nrow = 2)
```
...
```{r, fig.width=11, fig.height=6, fig.show="hold", cache=TRUE}
ggarrange(p1, p2, ncol = 2)
```
...
```{r, echo=FALSE, fig.width=12, fig.height=6, fig.show="hold"}
ggarrange(p1, p2, ncol = 2)
```
...
```{r, fig.width=12, fig.height=5, fig.show="hold"}
# mpg 데이터 셋
p0 <- ggplot(data = mpg) + 
  aes(x = displ, y = hwy)
...
```{r, fig.width=12, fig.height=6, fig.show="hold", cache=TRUE}
p2 <- p0 + 
...
```{r, fig.width=12, fig.height=8, fig.show="hold", cache=TRUE}
# economics_long 데이터셋
...
```{r, echo=FALSE, fig.width=10, fig.height=7, fig.show="hold"}
...
```{r, fig.width=11, fig.height=5, fig.show="hold"}
...
```{r, fig.width=11, fig.height=8, fig.show="hold", warning=FALSE}
