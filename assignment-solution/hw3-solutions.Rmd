...
<!-- ```{r} -->
<!-- df_titanic$age_group <- ifelse(df_titanic$age < 15, "Children", "Adult") -->
<!-- df_titanic$age_group <- with(df_titanic, factor(age_group, levels = c("Children", "Adult"))) -->
<!-- ``` -->
...
<!-- ```{r} -->
<!-- tab <- with(df_titanic, table(sex, survived, pclass)) -->
<!-- ptab <- lapply(1:3, function(x) prop.table(tab[,,x], margin = 1)) -->


<!-- tab <- with(df_titanic, table(age_group, survived, pclass)) -->
<!-- ptab <- lapply(1:3, function(x) prop.table(tab[,,x], margin = 1)) -->
