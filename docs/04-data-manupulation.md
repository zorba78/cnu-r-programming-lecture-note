...
# A tibble: 3 x 11
  manufacturer model    displ  year   cyl trans    drv     cty   hwy fl    class
  <chr>        <chr>    <dbl> <int> <int> <chr>    <chr> <int> <int> <chr> <chr>
1 dodge        durango~   4.7  2008     8 auto(l5) 4        13    17 r     suv  
2 dodge        caravan~   3.3  1999     6 auto(l4) f        16    22 r     mini~
3 toyota       camry      3    1999     6 manual(~ f        18    26 r     mids~
```
...
# A tibble: 12 x 11
   manufacturer model    displ  year   cyl trans  drv     cty   hwy fl    class 
   <chr>        <chr>    <dbl> <int> <int> <chr>  <chr> <int> <int> <chr> <chr> 
 1 dodge        dakota ~   5.2  1999     8 auto(~ 4        11    15 r     pickup
 2 toyota       camry s~   3.3  2008     6 auto(~ f        18    27 r     compa~
 3 audi         a4 quat~   2    2008     4 manua~ 4        20    28 p     compa~
 4 jeep         grand c~   4    1999     6 auto(~ 4        15    20 r     suv   
 5 subaru       impreza~   2.2  1999     4 auto(~ 4        21    26 r     subco~
 6 toyota       toyota ~   3.4  1999     6 auto(~ 4        15    19 r     pickup
 7 toyota       4runner~   3.4  1999     6 auto(~ 4        15    19 r     suv   
 8 ford         mustang    4.6  1999     8 manua~ r        15    22 r     subco~
 9 chevrolet    corvette   6.2  2008     8 manua~ r        16    26 p     2seat~
10 ford         explore~   4    1999     6 auto(~ 4        14    17 r     suv   
11 ford         f150 pi~   5.4  2008     8 auto(~ 4        13    17 r     pickup
12 chevrolet    malibu     3.1  1999     6 auto(~ f        18    26 r     midsi~
```
