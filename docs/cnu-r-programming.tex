...
\tightlist
\item
  스크립트(script) (Figure \ref{fig:rstudio-new-script})
\end{enumerate}
...
\tightlist
\item
  환경/명령기록(Environment/History) (Figure \ref{fig:rstudio-env})
\end{enumerate}
...
\begin{center}\includegraphics[width=0.9\linewidth]{figures/Rstudio-file} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{figures/RStudio-plotwin} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{figures/RStudio-packagewin} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{figures/RStudio-helpwin} \end{center}
