...
\begin{center}\includegraphics[width=0.8\linewidth]{figures/rstudio-glob-option} \end{center}
...
\item
  \textbf{Auto-indent code after paset}:
\item
  \textbf{Vertically align arguments in auto-indent}:
\item
  \textbf{Soft-wrap R source file}:
\item
  \textbf{Continue comment when inserting new line}:
\item
  \textbf{Surround selection on text insertino}:
\item
  \textbf{Focus console after executing from source}:
\end{itemize}
...
\tightlist
\item
  \textbf{Highlight selected word}:
\item
  \textbf{Highlight selected line}:
\item
  \textbf{Show line numbers}:
\item
  \textbf{Show margin}:
\item
  \textbf{Show whitespace characters}:
\item
  \textbf{Show indent guides}:
\item
  \textbf{Blinking cursor}:
\item
  \textbf{Show syntax highlighting in console output}:
\item
  \textbf{Allow scroll past end of document}:
\item
  \textbf{Allow drag and drop of text}:
\item
  \textbf{Highlight R function calls}:
\end{itemize}
